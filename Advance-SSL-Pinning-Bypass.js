// Stylish ASCII art representation of the name "DeadlyWeapon"
const stylishName = `
  ______          _      _               _      _______ _           
 |  ____|        (_)    | |             | |    |__   __| |          
 | |__ _ __ _   _ _  ___| |__   ___  ___| |_      | |  | |__   __ _ 
 |  __| '__| | | | |/ __| '_ \\ / _ \\/ __| __|     | |  | '_ \\ / _\` |
 | |  | |  | |_| | | (__| | | |  __/ (__| |_      | |  | | | | (_| |
 |_|  |_|   \\__,_|_|\\___|_| |_|\\___|\\___|\\__|     |_|  |_| |_|\\__,_|
                                                                     
`;

// Log the stylish name when the script starts
console.log(stylishName);

// Execution of the rest of the script...
setTimeout(function(){
    Java.perform(function (){
        console.log("");
        console.log("[+] Starting SSL Pinning Bypass/Re-Pinning...");
        ...
        // Anti-root detection and bypass
        const commonPaths = [
            "/data/local/bin/su",
            "/data/local/su",
            "/data/local/xbin/su",
...
var FINGERPRINT = Build.class.getDeclaredField("FINGERPRINT")
        ...
        // Start Anti-Root Detection Bypass
